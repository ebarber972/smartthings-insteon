...
preferences {
    input("deviceid", "text", title: "Device ID", description: "4564FC")
    input("host", "text", title: "URL", description: "172.16.1.97")
    input("port", "text", title: "Port", description: "25105")
    input("username", "text", title: "Username", description: "Francis5")
    input("password", "text", title: "Password", description: "sA8PGcAF")
} 
